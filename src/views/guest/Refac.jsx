          ...
          <div className="md:w-1/2 bg-black p-6 rounded-lg text-white md:mr-4 mb-4 md:mb-0">
            <div className="text-center">
              ...
              <p className="text-base md:text-lg mb-4 md:mb-8">
                En Mecánico Express nos preocupamos por el mejor desempeño de tu automóvil es por eso que usamos Refacciones Originales que aunados a un adecuado mantenimiento preventivo aumentarán el rendimiento de tu vehículo.
              </p>
              <p className="text-base md:text-lg mb-4 md:mb-8">
